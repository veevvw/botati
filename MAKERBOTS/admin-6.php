...
$config = [
    ...
    'start_msg' => "
  مرحبا بك عزيزي ( #name_user ) 👾
  
  • يمكنك من خلال البوت ترجمه النصوص بعده طرق
  
  - يمكنك ارسال النص و ترجمته مباشرتا ويمكنني ترجمة الصور كذالك,
  
  - يمكنك استخدام البوت اون لاين عن طريق كتابه معرف بوت في اي محادثة وبعدها النص المراد ترجمته ( تدعم العربيه والانكليزية فقط ) ,
  
  - يمكنك عن طريق اضافه البوت الى مجموعه خاصه بك ورد على رساله مراد ترجمتها مثلا :
  /ar 
  /en
  / + رمز الغه
  ~~~~~~~~~~~~~~~~
